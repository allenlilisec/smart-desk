...
import { AlertCircle, Plus, Search, Ticket, ArrowLeft, Clock } from 'lucide-react';
import { api } from '@/lib/api';
import type { Ticket as TicketType, TicketStatus, TicketPriority } from '@/types/ticket';
import { MY_TICKETS_TEST_IDS } from '@/lib/test-ids';

// 测试定位点别名
const TEST_IDS = MY_TICKETS_TEST_IDS;
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">我的工单</h1>
                <p className="text-sm text-gray-500">查看和管理您提交的所有工单</p>
              </div>
            </div>
            <Button onClick={navigateToNewTicket} data-testid={TEST_IDS.NEW_TICKET_BUTTON}>
            ...
            {loading ? (
              ...
              <div data-testid={TEST_IDS.EMPTY_STATE} className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {searchQuery ? '没有找到匹配的工单' : '暂无工单'}
                </h3>
                <p className="text-gray-500 mb-4">
                  {searchQuery ? '请尝试其他搜索词' : '您还没有提交过任何工单'}
                </p>
              ...
              <div data-testid={TEST_IDS.TICKETS_LIST} className="space-y-3">
                {filteredTickets.map((ticket) => {
                  ...
                  return (
                    <div
                      ...
                      className="p-4 rounded-lg border cursor-pointer transition-all hover:shadow-md hover:border-primary/50 bg-white"
                    >
